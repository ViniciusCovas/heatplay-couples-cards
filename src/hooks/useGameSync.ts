...
interface GameState {
  current_phase: 'proximity-selection' | 'card-display' | 'response-input' | 'evaluation' | 'interstitial' | 'level-selection' | 'waiting-for-evaluation' | 'final-report' | 'level-up-confirmation';
