-- Phase 2: Fix credit consumption race conditions and improve room creation flow

-- Update consume_credit function to be more atomic and handle room-specific consumption
