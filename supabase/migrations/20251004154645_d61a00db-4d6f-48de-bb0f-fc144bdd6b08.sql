-- Fix type mismatch in handle_level_selection function
-- Change player_id_param from TEXT to UUID to match the database schema

CREATE OR REPLACE FUNCTION public.handle_level_selection(
  room_id_param uuid,
  player_id_param uuid,  -- Changed from TEXT to UUID
