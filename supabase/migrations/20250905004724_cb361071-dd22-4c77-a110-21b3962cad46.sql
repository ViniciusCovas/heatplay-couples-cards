-- Fix the auto_advance_stuck_evaluations function (likely source of the updated_at error)
...
BEGIN
  ...
  FOR stuck_room IN 
    ...
    WHERE gr.current_phase = 'evaluation'
      ...
      AND gr.created_at > NOW() - INTERVAL '2 hours'  -- Use created_at, not updated_at
...
-- Fix the detect_disconnected_players function
